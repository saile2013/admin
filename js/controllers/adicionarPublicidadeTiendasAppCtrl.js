angular.module("sop").controller("adicionarPublicidadeTiendasAppCtrl", function($scope, $stateParams, $cookies, $state, servicosAPI){
	...
	$scope.salvar = function(){
		...
		servicosAPI.publicidadeTiendas($scope.idTien, dados).then(function (result) {
			$scope.botao = true;
			$scope.viewTiendas();
