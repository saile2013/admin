angular.module("sop").controller("adicionarRecomendadosCtrl", function($scope, $state, $stateParams, $cookies, servicosAPI){
	...
	$scope.selProd2 = function(id){
		...
		servicosAPI.postRecomendados(dads).then(function(result){
			$scope.productos();
		});
