angular.module("sop").controller("ativarLandpageCtrl", function($scope, $cookies, $state, $stateParams, Upload, servicosAPI){
	...
	$scope.upload = function (file) {
		...
		Upload.upload({
			url: 'https://managerb2b-backend.lorob2b.com/api/wb/admin/companies/'+$scope.id+'/users-validate',
			data: dados,
			headers: {
