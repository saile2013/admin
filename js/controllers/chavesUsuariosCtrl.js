angular.module("sop").controller("chavesUsuariosCtrl", function($scope, $cookies, $state, $stateParams, servicosAPI){
	...
	servicosAPI.getKeyUsers($scope.pag, $scope.id).then(function(result){
