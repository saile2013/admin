angular.module("sop").controller("desativarCidadesCtrl", function($scope, $state, $cookies, $state, servicosAPI){
	...
	servicosAPI.getShoCidades($scope.pag).then(function(result){
