angular.module("sop").controller("exportarPedidosPlansCtrl", function($scope, $cookies, $state, servicosAPI){
	...
	$scope.irSearch = function(){
		...
		if(($scope.data1 && $scope.data2) || $scope.tienda){
			...
			servicosAPI.csvPedidosPlans(data1, data2, $scope.tienda).then(function(result){
