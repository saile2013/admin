angular.module("sop").controller("gustadosEstatisticasCtrl", function($scope, $state, $cookies, $state, $stateParams, servicosAPI){
	...
	servicosAPI.getGustados($scope.id).then(function(result){
