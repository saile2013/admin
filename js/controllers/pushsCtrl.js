angular.module("sop").controller("pushsCtrl", function($scope, $state, $cookies, $state, servicosAPI){
	...
	$scope.buscar = function(){
		...
		if(!$scope.tipo){
			...
			servicosAPI.postPush(dados).then(function (result) {
				$scope.botao = true;
				document.getElementById('status').innerHTML = '¡Notificaciones enviadas a <b>'+result.data.notified_users+'</b> usuarios.!';
			});
		}
	};
