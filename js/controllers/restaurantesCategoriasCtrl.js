angular.module("sop").controller("restaurantesCategoriasCtrl", function($scope, $state, $cookies, $state, servicosAPI){
	...
	servicosAPI.getRestaurantesCategorias($scope.pag).then(function(result){
