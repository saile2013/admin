angular.module("sop").controller("searchIncriveisCtrl", function($scope, $cookies, $state, $stateParams, servicosAPI){
	...
	$scope.productos = () => {
		...
		servicosAPI.searchAmazing($scope.pag, $scope.text).then(function(result){
