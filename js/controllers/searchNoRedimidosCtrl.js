angular.module("sop").controller("searchNoRedimidosCtrl", function($scope, $state, $cookies, $state, $stateParams, servicosAPI){
	...
	servicosAPI.searchRedimidos($scope.text, $scope.pag).then(function(result){
