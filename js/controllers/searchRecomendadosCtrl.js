angular.module("sop").controller("searchRecomendadosCtrl", function($scope, $cookies, $state, $stateParams, servicosAPI){
	...
	$scope.productos = () => {
		...
		servicosAPI.searchRecomendados($scope.pag, $scope.text).then(function(result){
