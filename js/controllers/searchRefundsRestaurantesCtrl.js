angular.module("sop").controller("searchRefundsRestaurantesCtrl", function($scope, $state, $cookies, $state, $stateParams, servicosAPI){
	...
	$scope.seleData = function(){
		...
		$state.go('search-refunds-restaurantes', {text:$scope.buscando, begin:data1, end:data2});
	}
