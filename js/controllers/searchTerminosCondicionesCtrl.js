angular.module("sop").controller("searchTerminosCondicionesCtrl", function($scope, $state, $cookies, $state, $stateParams, servicosAPI){
	...
	$scope.start_at = $stateParams.start_at;
	$scope.finish_at = $stateParams.finish_at;

	$scope.pag = 1;
	$scope.apa = true;
	var pedidos = [];
		
	servicosAPI.searchTerminosCod($scope.pag, $scope.start_at, $scope.finish_at).then(function(result){
