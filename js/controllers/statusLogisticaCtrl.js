angular.module("sop").controller("statusLogisticaCtrl", function($scope, $cookies, $state, servicosAPI){
	...
	$scope.verre = function(){
		$state.go('search-status-logistica', {tienda:$scope.tienda, transportadora:null, status:null, text:null, begin:null, end:null, hra1:null, hra2:null});
	};

	$scope.trans = function(){
		$state.go('search-status-logistica', {tienda:null, transportadora:$scope.transportadora, status:null, text:null, begin:null, end:null, hra1:null, hra2:null});
	};

	$scope.estaDo = function(){
		$state.go('search-status-logistica', {tienda:null, transportadora:null, status:$scope.statO, text:null, begin:null, end:null, hra1:null, hra2:null});
	};
	
	$scope.viewStatus = function(){
		servicosAPI.statusLogistica($scope.pag).then(function(result) {
	...
	$scope.verDatas = function() {
		if($scope.data2){
			...
			$state.go('search-status-logistica', {tienda:null, transportadora:null, status:null, text:null, begin:data1, end:data2, hra1:hra1, hra2:hra2});
		}
	};
	...
	$scope.buscar = function(){
		if($scope.buscando){
			$state.go('search-status-logistica', {tienda:null, transportadora:null, status:null, text:$scope.buscando, begin:null, end:null, hra1:null, hra2:null});
		}
	};
