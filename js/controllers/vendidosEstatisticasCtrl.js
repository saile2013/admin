angular.module("sop").controller("vendidosEstatisticasCtrl", function($scope, $state, $cookies, $state, $stateParams, servicosAPI){
	...
	servicosAPI.getVendidos($scope.id).then(function(result){
		console.log(result);
